...
import { MenuAlign } from '@spartan-ng/brain/core';
...
declare class BrnNavigationMenuTrigger implements OnInit, OnDestroy, FocusableOption {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnNavigationMenuTrigger, "button[brnNavigationMenuTrigger]", never, { "align": { "alias": "align"; "required": false; "isSignal": true; }; }, {}, never, never, true, [{ directive: typeof i1.BrnButton; inputs: { "disabled": "disabled"; }; outputs: {}; }]>;
}
