...
declare class BrnAutocompleteInput<T> {
    ...
    protected readonly _autocompleteListId: _angular_core.Signal<string | undefined>;
...
declare class BrnAutocompleteList {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnAutocompleteList, "[brnAutocompleteList]", never, { "id": { "alias": "id"; "required": false; "isSignal": true; }; "ariaLabel": { "alias": "aria-label"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
...
declare class BrnAutocomplete<T> implements BrnAutocompleteBase<T>, ControlValueAccessor {
    ...
    private readonly _autocompleteList;
