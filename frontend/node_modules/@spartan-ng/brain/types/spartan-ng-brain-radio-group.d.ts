...
declare class BrnRadioGroup<T = unknown> implements ControlValueAccessor {
     ...
     */
    readonly valueInput: _angular_core.InputSignal<T | undefined>;
    readonly value: _angular_core.WritableSignal<T | undefined>;
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnRadioGroup<any>, "[brnRadioGroup]", never, { "name": { "alias": "name"; "required": false; "isSignal": true; }; "valueInput": { "alias": "value"; "required": false; "isSignal": true; }; "disabled": { "alias": "disabled"; "required": false; "isSignal": true; }; "required": { "alias": "required"; "required": false; "isSignal": true; }; }, { "valueChange": "valueChange"; "change": "change"; }, ["radioButtons"], never, true, [{ directive: typeof i1.BrnFieldControl; inputs: {}; outputs: {}; }]>;
}
