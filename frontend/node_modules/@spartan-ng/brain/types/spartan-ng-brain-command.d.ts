...
declare class BrnCommandList {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnCommandList, "[brnCommandList]", never, { "id": { "alias": "id"; "required": false; "isSignal": true; }; "ariaLabel": { "alias": "aria-label"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
...
declare class BrnCommand implements ControlValueAccessor {
    ...
    registerCommandList(list: BrnCommandList): void;
...
declare class BrnCommandInput {
    ...
    protected readonly _commandListId: _angular_core.Signal<string | undefined>;
...
declare class BrnCommandSeparator {
    ...
    protected readonly _hasSearchInput: _angular_core.Signal<boolean>;
