...
declare class BrnToggleGroup<T = unknown> implements ControlValueAccessor {
    ...
    readonly valueInput: _angular_core.InputSignal<ToggleValue<T>>;
    readonly value: _angular_core.WritableSignal<ToggleValue<T>>;
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnToggleGroup<any>, "[brnToggleGroup],brn-toggle-group", ["brnToggleGroup"], { "type": { "alias": "type"; "required": false; "isSignal": true; }; "valueInput": { "alias": "value"; "required": false; "isSignal": true; }; "nullable": { "alias": "nullable"; "required": false; "isSignal": true; }; "disabled": { "alias": "disabled"; "required": false; "isSignal": true; }; }, { "valueChange": "valueChange"; "change": "change"; }, never, never, true, never>;
}
