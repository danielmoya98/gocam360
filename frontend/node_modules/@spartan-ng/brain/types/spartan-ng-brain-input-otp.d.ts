...
declare class BrnInputOtp implements ControlValueAccessor {
    ...
    readonly invalid: _angular_core.Signal<boolean | null> | undefined;
    readonly touched: _angular_core.Signal<boolean | null> | undefined;
    readonly dirty: _angular_core.Signal<boolean | null> | undefined;
    readonly spartanInvalid: _angular_core.Signal<boolean | null> | undefined;
    ...
    readonly labelableId: _angular_core.InputSignal<string>;
    ...
    readonly valueInput: _angular_core.InputSignal<string | null>;
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<BrnInputOtp, "brn-input-otp", never, { "hostStyles": { "alias": "hostStyles"; "required": false; "isSignal": true; }; "inputId": { "alias": "inputId"; "required": false; "isSignal": true; }; "inputAutocomplete": { "alias": "inputAutocomplete"; "required": false; "isSignal": true; }; "inputStyles": { "alias": "inputStyles"; "required": false; "isSignal": true; }; "containerStyles": { "alias": "containerStyles"; "required": false; "isSignal": true; }; "disabled": { "alias": "disabled"; "required": false; "isSignal": true; }; "length": { "alias": "length"; "required": true; "isSignal": true; }; "inputMode": { "alias": "inputMode"; "required": false; "isSignal": true; }; "inputClass": { "alias": "inputClass"; "required": false; "isSignal": true; }; "autofocus": { "alias": "autofocus"; "required": false; "isSignal": true; }; "transformPaste": { "alias": "transformPaste"; "required": false; "isSignal": true; }; "valueInput": { "alias": "value"; "required": false; "isSignal": true; }; }, { "valueChange": "valueChange"; "completed": "completed"; }, never, ["*"], true, [{ directive: typeof i1.BrnFieldControl; inputs: {}; outputs: {}; }]>;
}
...
declare class BrnInputOtpSlot {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<BrnInputOtpSlot, "brn-input-otp-slot", never, { "index": { "alias": "index"; "required": true; "isSignal": true; }; "forceInvalid": { "alias": "forceInvalid"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, never>;
}
