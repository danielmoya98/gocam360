...
class BrnSlider {
    ...
    id = input(`brn-slider-${++nextId}`, ...(ngDevMode ? [{ debugName: "id" }] : /* istanbul ignore next */ []));
    ...
    maxTicks = input(25, { ...(ngDevMode ? { debugName: "maxTicks" } : /* istanbul ignore next */ {}), transform: numberAttribute });
    /** Interval at which tick labels are shown. A value of `2` shows a label every second tick. */
    tickLabelInterval = input(2, { ...(ngDevMode ? { debugName: "tickLabelInterval" } : /* istanbul ignore next */ {}), transform: numberAttribute });
    /** Defines how the tick should be displayed in the UI. */
    formatTick = input((tick) => tick.toString(), ...(ngDevMode ? [{ debugName: "formatTick" }] : /* istanbul ignore next */ []));
    /** Whether dragging the selected range should move all thumbs together. */
    draggableRange = input(false, { ...(ngDevMode ? { debugName: "draggableRange" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    /** Whether only dragging the range should work (overrides normal track clicks). */
    draggableRangeOnly = input(false, { ...(ngDevMode ? { debugName: "draggableRangeOnly" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    /** Emits when the value changes. */
    valueChange = output();
    /** @internal Normalized slider values. Values are clamped to `[min, max]` and sorted in ascending order. */
    normalizedValue = computed(() => [...this.value()].sort((a, b) => a - b).map((v) => clamp(v, [this.min(), this.max()])), { ...(ngDevMode ? { debugName: "normalizedValue" } : /* istanbul ignore next */ {}), equal: areArrsEqual });
    /** Indexes for all active thumbs. */
    thumbIndexes = computed(() => Array.from({ length: this.normalizedValue().length }, (_, i) => i), { ...(ngDevMode ? { debugName: "thumbIndexes" } : /* istanbul ignore next */ {}), equal: (a, b) => a.length === b.length });
    /** @internal Whether the slider is in range mode and draggable range is enabled */
    isDraggableRange = computed(() => this.draggableRange() && this.normalizedValue().length > 1, ...(ngDevMode ? [{ debugName: "isDraggableRange" }] : /* istanbul ignore next */ []));
    /** @internal Whether dragging should only move the range. */
    isDraggableRangeOnly = computed(() => this.draggableRangeOnly() && this.isDraggableRange(), ...(ngDevMode ? [{ debugName: "isDraggableRangeOnly" }] : /* istanbul ignore next */ []));
    ...
    }, ...(ngDevMode ? [{ debugName: "slidingSource" }] : /* istanbul ignore next */ []));
    /** @internal */
    ...
    track = signal(null, ...(ngDevMode ? [{ debugName: "track" }] : /* istanbul ignore next */ []));
    /** @internal Reference to the slider range instance. */
    range = signal(null, ...(ngDevMode ? [{ debugName: "range" }] : /* istanbul ignore next */ []));
    /** @internal All registered slider thumbs. */
    thumbs = signal([], ...(ngDevMode ? [{ debugName: "thumbs" }] : /* istanbul ignore next */ []));
    /** @internal Index of the thumb currently being updated. */
    valueIndexToChange = signal(0, ...(ngDevMode ? [{ debugName: "valueIndexToChange" }] : /* istanbul ignore next */ []));
    ...
    mutableDisabled = linkedSignal(() => this.disabled(), ...(ngDevMode ? [{ debugName: "mutableDisabled" }] : /* istanbul ignore next */ []));
...
class BrnSliderRange {
    ...
    _rangeInset = computed(() => {
        ...
        return inset.join(' ');
    }, ...(ngDevMode ? [{ debugName: "_rangeInset" }] : /* istanbul ignore next */ []));
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderRange, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.16", type: BrnSliderRange, isStandalone: true, selector: "[brnSliderRange]", host: { attributes: { "data-slot": "slider-range" }, properties: { "attr.data-disabled": "_slider.mutableDisabled() ? \"\" : null", "attr.data-orientation": "_slider.orientation()", "attr.data-draggable-range": "_slider.isDraggableRange() ? \"\" : null", "style.inset-inline": "_slider.isHorizontal() ? _rangeInset() : undefined", "style.inset-block": "!_slider.isHorizontal() ? _rangeInset() : undefined" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderRange, decorators: [{
            type: Directive,
            args: [{
...
class BrnSliderThumb {
    ...
    }, ...(ngDevMode ? [{ debugName: "_thumbReady" }] : /* istanbul ignore next */ []));
    _index = computed(() => this._slider.thumbs().findIndex((thumb) => thumb === this), ...(ngDevMode ? [{ debugName: "_index" }] : /* istanbul ignore next */ []));
    percentage = computed(() => {
    ...
    }, ...(ngDevMode ? [{ debugName: "_thumbInBoundsOffset" }] : /* istanbul ignore next */ []));
    /**
    ...
    }, ...(ngDevMode ? [{ debugName: "_thumbOffset" }] : /* istanbul ignore next */ []));
    _computedAriaLabel = computed(() => this._slider.ariaLabel() || `Value ${this._index() + 1} of ${this._slider.normalizedValue().length}`, ...(ngDevMode ? [{ debugName: "_computedAriaLabel" }] : /* istanbul ignore next */ []));
    _transformValue = computed(() => this._slider.orientation() === 'horizontal' ? 'translateX(-50%)' : 'translateY(-50%)', ...(ngDevMode ? [{ debugName: "_transformValue" }] : /* istanbul ignore next */ []));
    constructor() {
    ...
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderThumb, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.16", type: BrnSliderThumb, isStandalone: true, selector: "[brnSliderThumb]", host: { attributes: { "role": "slider", "data-slot": "slider-thumb" }, listeners: { "pointerdown": "_onPointerDown($event)", "pointermove": "_onPointerMove($event)", "pointerup": "_onPointerUp($event)", "keydown": "handleKeydown($event)" }, properties: { "attr.aria-label": "_computedAriaLabel()", "attr.aria-labelledby": "_slider.ariaLabelledby() || null", "attr.aria-orientation": "_slider.orientation()", "attr.aria-valuenow": "_slider.normalizedValue()[_index()]", "attr.aria-valuemin": "_slider.min()", "attr.aria-valuemax": "_slider.max()", "attr.tabindex": "_slider.mutableDisabled() ? -1 : 0", "attr.data-disabled": "_slider.mutableDisabled() ? \"\" : null", "attr.data-orientation": "_slider.orientation()", "style.inset-inline-start": "_slider.isHorizontal() ?  _slider.inverted() ? undefined : _thumbOffset() : undefined", "style.inset-inline-end": "_slider.isHorizontal() ? _slider.inverted() ? _thumbOffset() : undefined : undefined", "style.inset-block-end": "!_slider.isHorizontal() ? _slider.inverted() ? undefined : _thumbOffset() : undefined", "style.inset-block-start": "!_slider.isHorizontal() ? _slider.inverted() ? _thumbOffset() : undefined : undefined", "style.visibility": "_thumbReady() ? undefined : \"hidden\"", "style.pointer-events": "_thumbReady() ? undefined : \"none\"", "style.transform": "_transformValue()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderThumb, decorators: [{
            type: Directive,
            args: [{
...
class BrnSliderTick {
    ...
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderTick, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.16", type: BrnSliderTick, isStandalone: true, selector: "[brnSliderTick]", host: { attributes: { "data-slot": "slider-tick" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderTick, decorators: [{
            type: Directive,
            args: [{
...
class BrnSliderTrack {
    ...
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderTrack, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.2.16", type: BrnSliderTrack, isStandalone: true, selector: "[brnSliderTrack]", host: { attributes: { "data-slot": "slider-track" }, listeners: { "pointerdown": "onPointerDown($event)", "pointermove": "onPointerMove($event)", "pointerup": "onPointerUp($event)" }, properties: { "attr.data-disabled": "_slider.mutableDisabled() ? \"\" : null", "attr.data-orientation": "_slider.orientation()" } }, providers: [provideBrnSliderTrack(BrnSliderTrack)], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSliderTrack, decorators: [{
            type: Directive,
            args: [{
