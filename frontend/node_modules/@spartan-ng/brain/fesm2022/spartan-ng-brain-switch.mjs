...
import { forwardRef, inject, DestroyRef, Renderer2, PLATFORM_ID, ElementRef, ChangeDetectorRef, DOCUMENT, signal, input, booleanAttribute, linkedSignal, output, numberAttribute, viewChild, computed, afterRenderEffect, ChangeDetectionStrategy, Component } from '@angular/core';
...
class BrnSwitch {
    ...
    _focusVisible = signal(false, ...(ngDevMode ? [{ debugName: "_focusVisible" }] : /* istanbul ignore next */ []));
     ...
     */
    id = input(++uniqueIdCounter + '', ...(ngDevMode ? [{ debugName: "id" }] : /* istanbul ignore next */ []));
    /**
    ...
    mutableAriaLabelledby = linkedSignal(() => this.ariaLabelledby(), ...(ngDevMode ? [{ debugName: "mutableAriaLabelledby" }] : /* istanbul ignore next */ []));
    /**
    ...
    labelableId = computed(() => this.getSwitchButtonId(this._state().id), ...(ngDevMode ? [{ debugName: "labelableId" }] : /* istanbul ignore next */ []));
    constructor() {
        afterRenderEffect(() => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSwitch, decorators: [{
            type: Component,
            args: [{
                    selector: 'brn-switch',
...
class BrnSwitchThumb {
    ...
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSwitchThumb, deps: [], target: i0.ɵɵFactoryTarget.Component });
    /** @nocollapse */ static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.16", type: BrnSwitchThumb, isStandalone: true, selector: "brn-switch-thumb", host: { attributes: { "role": "presentation" }, listeners: { "click": "$event.preventDefault()" }, properties: { "attr.data-state": "_switch.checked() ? 'checked' : 'unchecked'" } }, ngImport: i0, template: '', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnSwitchThumb, decorators: [{
            type: Component,
            args: [{
