...
class BrnRadio {
     ...
     */
    _disabledState = computed(() => this.disabled() || this._radioGroup.disabledState(), ...(ngDevMode ? [{ debugName: "_disabledState" }] : /* istanbul ignore next */ []));
    /**
     * Whether the radio button is checked.
     */
    _checked = computed(() => this._radioGroup.value() === this.value(), ...(ngDevMode ? [{ debugName: "_checked" }] : /* istanbul ignore next */ []));
    /**
    ...
    }, ...(ngDevMode ? [{ debugName: "_hostId" }] : /* istanbul ignore next */ []));
    _inputId = computed(() => {
        return this.id() ?? `brn-radio${INPUT_POST_FIX}-${++BrnRadio._nextUniqueId}`;
    }, ...(ngDevMode ? [{ debugName: "_inputId" }] : /* istanbul ignore next */ []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnRadio, decorators: [{
            type: Component,
            args: [{
                    selector: 'brn-radio',
                    exportAs: 'brnRadio',
...
class BrnRadioGroup {
    ...
    onChange = () => { };
    onTouched = () => { };
    name = input(`brn-radio-group-${++BrnRadioGroup._nextUniqueId}`, ...(ngDevMode ? [{ debugName: "name" }] : /* istanbul ignore next */ []));
    /**
    ...
    _ariaInvalid = computed(() => this._fieldControl?.invalid(), ...(ngDevMode ? [{ debugName: "_ariaInvalid" }] : /* istanbul ignore next */ []));
    _spartanInvalid = computed(() => this._fieldControl?.spartanInvalid(), ...(ngDevMode ? [{ debugName: "_spartanInvalid" }] : /* istanbul ignore next */ []));
    _dirty = computed(() => this._fieldControl?.dirty(), ...(ngDevMode ? [{ debugName: "_dirty" }] : /* istanbul ignore next */ []));
    _touched = computed(() => this._fieldControl?.touched(), ...(ngDevMode ? [{ debugName: "_touched" }] : /* istanbul ignore next */ []));
    /**
     * Access the radio buttons within the group.
     * @internal
     */
    radioButtons = contentChildren(BrnRadio, { ...(ngDevMode ? { debugName: "radioButtons" } : /* istanbul ignore next */ {}), descendants: true });
    writeValue(value) {
