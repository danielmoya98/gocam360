...
import { input, inject, ElementRef, numberAttribute, booleanAttribute, signal, computed, Directive, contentChildren, output, model, DOCUMENT, NgZone, DestroyRef, afterRenderEffect, untracked, afterNextRender } from '@angular/core';

let nextId$1 = 0;
class BrnResizablePanel {
    /** Unique ID for the panel.   */
    id = input(`brn-resizable-panel-${++nextId$1}`, ...(ngDevMode ? [{ debugName: "id" }] : /* istanbul ignore next */ []));
     ...
     */
    defaultSize = input(undefined, { ...(ngDevMode ? { debugName: "defaultSize" } : /* istanbul ignore next */ {}), transform: numberAttribute });
    ...
    maxSize = input(100, { ...(ngDevMode ? { debugName: "maxSize" } : /* istanbul ignore next */ {}), transform: numberAttribute });
    ...
    _panelSize = signal(undefined, ...(ngDevMode ? [{ debugName: "_panelSize" }] : /* istanbul ignore next */ []));
    /**
    ...
    _flex = computed(() => {
        ...
        return `${size} 1 0`;
    }, ...(ngDevMode ? [{ debugName: "_flex" }] : /* istanbul ignore next */ []));
    /**
...
class BrnResizableGroup {
    ...
    id = input(`brn-resizable-group-${++nextId}`, ...(ngDevMode ? [{ debugName: "id" }] : /* istanbul ignore next */ []));
    ...
    panels = contentChildren(BrnResizablePanel, ...(ngDevMode ? [{ debugName: "panels" }] : /* istanbul ignore next */ []));
    /** event when resize starts */
    dragStart = output();
    /** event when resize ends */
    dragEnd = output();
    /** Resize panel group to the specified layout ([1 - 100, ...]). */
    layout = model([], ...(ngDevMode ? [{ debugName: "layout" }] : /* istanbul ignore next */ []));
    ...
    _synchronizePanelSizes(panels, currentLayout) {
        ...
        if (isInitialLayout) {
            ...
            const newPanelSizes = new Map(panels
            ...
            if (newPanelsTotal <= 100 && previousPanelsTotal > 0) {
                ...
                sizes = panels.map((panel) => newPanelSizes.get(panel) ?? ((previousSizes.get(panel) ?? 0) / previousPanelsTotal) * remainingSize);
            }
            else {
    ...
    _handleResize(event, handleIndex, startPosition, startSizes, isRtl = false) {
    ...
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnResizableGroup, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.2.0", version: "21.2.16", type: BrnResizableGroup, isStandalone: true, selector: "brn-resizable-group, [brnResizableGroup]", inputs: { id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null }, direction: { classPropertyName: "direction", publicName: "direction", isSignal: true, isRequired: false, transformFunction: null }, layout: { classPropertyName: "layout", publicName: "layout", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { dragStart: "dragStart", dragEnd: "dragEnd", layout: "layoutChange", layoutChanged: "layoutChanged" }, host: { attributes: { "data-panel-group": "", "data-slot": "resizable-panel-group" }, properties: { "attr.data-panel-group-direction": "direction()", "attr.data-panel-group-id": "id()", "id": "id()" } }, queries: [{ propertyName: "panels", predicate: BrnResizablePanel, isSignal: true }], exportAs: ["brnResizableGroup"], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnResizableGroup, decorators: [{
            type: Directive,
            args: [{
...
class BrnResizableHandle {
    ...
    _layout = computed(() => this._resizable?.direction() || 'horizontal', ...(ngDevMode ? [{ debugName: "_layout" }] : /* istanbul ignore next */ []));
