...
class BrnAutocomplete {
    ...
    _autocompleteList = signal(undefined, ...(ngDevMode ? [{ debugName: "_autocompleteList" }] : /* istanbul ignore next */ []));
    /** @internal The id of the autocomplete list, registered by BrnAutocompleteList. Used by the input for aria-controls. */
    listId = computed(() => this._autocompleteList()?.id(), ...(ngDevMode ? [{ debugName: "listId" }] : /* istanbul ignore next */ []));
    _onChange;
    _onTouched;
...
class BrnAutocompleteInput {
    ...
    _autocompleteListId = this._autocomplete.listId;
...
class BrnAutocompleteList {
    ...
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.2.16", type: BrnAutocompleteList, isStandalone: true, selector: "[brnAutocompleteList]", inputs: { id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null }, ariaLabel: { classPropertyName: "ariaLabel", publicName: "aria-label", isSignal: true, isRequired: false, transformFunction: null } }, host: { attributes: { "role": "listbox", "tabIndex": "-1", "aria-orientation": "vertical" }, properties: { "id": "id()", "attr.data-empty": "!_visibleItems() ? \"\" : null", "attr.aria-label": "ariaLabel()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnAutocompleteList, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { id: [{ type: i0.Input, args: [{ isSignal: true, alias: "id", required: false }] }], ariaLabel: [{ type: i0.Input, args: [{ isSignal: true, alias: "aria-label", required: false }] }] } });
