...
class BrnCheckbox {
    ...
    }, ...(ngDevMode ? [{ debugName: "_ariaChecked" }] : /* istanbul ignore next */ []));
    /**
    ...
    _buttonId = computed(() => this._getCheckboxButtonId(this._state().id), ...(ngDevMode ? [{ debugName: "_buttonId" }] : /* istanbul ignore next */ []));
    _buttonName = computed(() => this._getCheckboxButtonId(this._state().name), ...(ngDevMode ? [{ debugName: "_buttonName" }] : /* istanbul ignore next */ []));
    labelableId = this._buttonId;
    _dirty = this._fieldControl?.dirty;
    _invalid = computed(() => this.forceInvalid() || (this._fieldControl?.invalid?.() ?? null), ...(ngDevMode ? [{ debugName: "_invalid" }] : /* istanbul ignore next */ []));
    spartanInvalid = computed(() => this.forceInvalid() || (this._fieldControl?.spartanInvalid?.() ?? null), ...(ngDevMode ? [{ debugName: "spartanInvalid" }] : /* istanbul ignore next */ []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.16", ngImport: i0, type: BrnCheckbox, decorators: [{
            type: Component,
            args: [{
