...
exports.brnCheckboxChangedEventRename = void 0;
const tslib_1 = require("tslib");
const devkit_1 = require("@nx/devkit");
const generator_1 = tslib_1.__importDefault(require("../../migrate-brn-checkbox-changed-event/generator"));
const healthchecks_1 = require("../healthchecks");
exports.brnCheckboxChangedEventRename = {
    ...
    async detect(tree, failure) {
        (0, devkit_1.visitNotIgnoredFiles)(tree, '/', (file) => {
            ...
            if (/<(brn-checkbox)[^>]*\(\s*changed\s*\)=/g.test(contents)) {
                failure('Checkbox is using the renamed changed event.', healthchecks_1.HealthcheckSeverity.Error, true);
            }
        });
    },
    fix: async (tree) => {
...
//# sourceMappingURL=brn-checkbox-changed-event-rename.js.map