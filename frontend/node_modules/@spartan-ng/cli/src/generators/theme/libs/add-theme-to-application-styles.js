...
@import 'tailwindcss/utilities.css';
    ...
    const colorScheme = colors_1.themes[options.theme];
 ...
 */
function splitLeadingImports(content) {
    const lines = content.split('\n');
    let boundary = 0;
    for (const line of lines) {
        const trimmed = line.trim();
        const isLeading = trimmed === '' ||
