...
exports.migrateBrnToggleGroupGenerator = migrateBrnToggleGroupGenerator;
const devkit_1 = require("@nx/devkit");
const visit_files_1 = require("../../utils/visit-files");
async function migrateBrnToggleGroupGenerator(tree, { skipFormat }) {
    updateImports(tree);
...
exports.default = migrateBrnToggleGroupGenerator;
