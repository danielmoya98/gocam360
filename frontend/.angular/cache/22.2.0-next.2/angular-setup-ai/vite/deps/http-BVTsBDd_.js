...
import { Ft as APP_BOOTSTRAP_LISTENER, Ha as ɵɵdefineNgModule, Nn as NgModule, Vt as ApplicationRef, Wa as ɵɵdefineService, Zn as Service, bn as Inject, di as performanceMarkFeature, ki as setClassMetadata, lr as TracingService, xn as Injectable } from "./core-DSXoV5I5.js";
import { Ft as concatMap, Qt as filter, Sn as of, Yn as Observable, fn as map, lt as finalize, x as switchMap } from "./zipWith-BIPy9JuQ.js";
import { n as parseCookieValue, o as PlatformLocation, t as XhrFactory } from "./_xhr-chunk-D2zuFHeB.js";
...
function retrieveStateFromCache(req, options, transferState, originMap, storeKey, skipUseCacheChecks = false) {
	...
	switch (responseType) {
		case "arraybuffer":
			...
			break;
		case "blob": body = new Blob([fromBase64(undecodedBody)]);
	}
				...
				next: (event) => {
					switch (event.type) {
						case HttpEventType.Response:
							...
							break;
						case HttpEventType.DownloadProgress: this._progress.set(event);
					}
				},
				error: (error) => {
